...
players = [
  ...
  {name:"Luis Suarez",shooting:93, passing:85, defense:48, foul:8, dribbling:91, team_id:2, user_team_ids: [2],  position: "forward"},
  ...
  {name: "Petr Cech",shooting:39, passing:45, defense:90, foul:25, dribbling:31, team_id:3, user_team_ids: [4], position:"goalie"},
  ...
  {name: "Roman Burki",shooting:20, passing:50, defense:88, foul:5, dribbling:30, team_id:4, user_team_ids: [5], position:"goalie"},
  ...
  {name: "David De Gea",shooting:20, passing:55, defense:97, foul:5, dribbling:35, team_id:5, user_team_ids: [6], position:"goalie"},
  ...
  {name: "Thiago Alcantara",shooting:75, passing:83, defense:58, foul:25, dribbling:89, team_id:8, user_team_ids: [7], position:"midfielder"},
